...
class FileSystem
{
     ...
     *  @return string aaa
     */
    public static function mergePath(string ...$pathParts): string
    {
     ...
     *  @return number aaa
     */
    public static function addPath(string $origin, string ...$path): string
    {
        $path = self::mergePath(...$path);
     ...
     */
    public static function resolveSrc(string $url, string $src): string
    {
